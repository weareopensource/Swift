...
internal enum L10n {
  ...
  /// Biography
  internal static let userEditBio = L10n.tr("Localizable", "user_edit_bio")
  /// Firstname
  ...
  /// Account
  internal static let userEditSectionAccount = L10n.tr("Localizable", "user_edit_section_account")
  /// Profile picture
  ...
  /// More informations
  internal static let userMore = L10n.tr("Localizable", "user_more")
  /// Preferences
  ...
  /// Follow us !
  internal static let userSectionSocialnetworks = L10n.tr("Localizable", "user_section_socialnetworks")
  /// Website
